    ...
    <div className="space-y-6 animate-in fade-in duration-300 w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="h-10 w-24 bg-slate-800/60 rounded-xl animate-pulse" />
          <div className="h-12 w-32 bg-slate-800 rounded-xl animate-pulse" />
        </div>
      </div>

      {/* Skeleton toolbar (search/filter) */}
      <div className="flex gap-4">
        <div className="h-12 w-full bg-slate-900 border border-slate-800 rounded-xl animate-pulse" />
        <div className="h-12 w-12 bg-slate-900 border border-slate-800 rounded-xl animate-pulse flex-shrink-0" />
      </div>

      {/* Skeleton main content (table/list style) */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
        {/* Table Header */}
        <div className="bg-slate-800/50 flex px-6 py-4 gap-4">
